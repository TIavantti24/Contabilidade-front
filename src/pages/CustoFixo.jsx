...
const FILHO_COLORS = {
  'Energia': '#c0392b',
  'Imobiliaria': '#d97706',
  'Desp. Gerais e Res. Financ.': '#2563eb',
}
const filhoColor = nome => FILHO_COLORS[nome] || '#7c3aed'
...
export default function CustoFixo() {
  ...
  useEffect(() => {
    ...
    if (selAtiv) {
      ...
      // Mês selecionado: eixo X = atividades
      ...
      // Total anual: barras empilhadas por atividade, eixo X = meses
      labels = MONTH_SHORT
      const atividadesSet = new Set()
      for (const filhos of Object.values(hierarquia))
